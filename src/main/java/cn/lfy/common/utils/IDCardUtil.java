...
public class IDCardUtil {
    ...
    private final static Hashtable<String, String> areaTable = new Hashtable<String, String>();
    ...
    * */
    ...
    public static String IDCardValidate(String IDStr) throws ParseException {
        ...
        if (IDStr.length() == 18) {
            if (!Ai.equalsIgnoreCase(IDStr)) { //不区分大小写判断
    ...
    public static void main(String[] args) throws ParseException {
        String IDCardNum = "61042419910113003X";
